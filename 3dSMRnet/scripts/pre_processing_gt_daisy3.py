...
def main():
    poissonDiskSampleDF2x = pd.read_csv("/media/daisy3/Data/data_set/MPISystemMatrix/grids/ok/sampledPoints_2x.csv", header=None)
    poissonDiskSample2x = poissonDiskSampleDF2x.to_numpy()
    poissonDiskSampleDF4x = pd.read_csv("/media/daisy3/Data/data_set/MPISystemMatrix/grids/ok/sampledPoints_4x.csv", header=None)
